...
const competencyTemplates = [
  {
    ...
    questions: [
      mc("q1", "What is the name of the upper moving component of a press brake that applies force to bend the material?", ["Die (lower tool)", "Punch (upper tool)", "Back gauge", "Ram plate"], "B", "\u00bfCu\u00e1l es el nombre del componente superior m\u00f3vil de una dobladora que aplica fuerza para doblar el material?", ["Matriz (dado inferior)", "Punz\u00f3n (herramienta superior)", "Tope trasero", "Placa del ariete"]),
      mc("q2", "What is the function of the die on a press brake?", ["To hold the back gauge in place", "To clamp the material from the top", "To receive the material and give the bend its shape and angle", "To control ram speed"], "C", "\u00bfCu\u00e1l es la funci\u00f3n de la matriz (dado) en una dobladora de prensa?", ["Sujetar el tope trasero en su lugar", "Sujetar el material desde arriba", "Recibir el material y dar forma y \u00e1ngulo al doblez", "Controlar la velocidad del ariete"]),
      mc("q3", "What does the back gauge on a press brake do?", ["Controls the ram stroke speed", "Positions the material at the correct distance from the punch for consistent bends", "Measures the tonnage applied", "Controls the crowning of the bed"], "B", "\u00bfPara qu\u00e9 sirve el tope trasero (back gauge) en una dobladora?", ["Controla la velocidad del ariete", "Posiciona el material a la distancia correcta del punz\u00f3n para obtener dobleces consistentes", "Mide la tonelada aplicada", "Controla el coronado de la mesa"]),
      mc("q4", "What is 'crowning' on a press brake bed?", ["The maximum height the ram can travel", "A compensation adjustment on the bed to correct deflection and produce a consistent angle across the full bend length", "A type of punch profile used for acute angles", "The tonnage setting limit"], "B", "\u00bfQu\u00e9 es el 'coronado' en la mesa de una dobladora?", ["La altura m\u00e1xima que puede recorrer el ariete", "Un ajuste de compensaci\u00f3n en la mesa para corregir la deflexi\u00f3n y producir un \u00e1ngulo consistente a lo largo del doblez", "Un tipo de perfil de punz\u00f3n para \u00e1ngulos agudos", "El l\u00edmite de tonelaje ajustable"]),
      mc("q5", "What is 'springback' in sheet metal bending and how does an operator compensate for it?", ["When the machine bounces back; operator tightens the ram", "When the die moves; operator replaces the die", "When metal partially returns toward its original shape after bending; operator overbends slightly to account for it", "A hydraulic pressure drop; operator adds hydraulic fluid"], "C", "\u00bfQu\u00e9 es el 'retorno el\u00e1stico' (springback) en el doblado de varilla y c\u00f3mo lo compensa el operador?", ["Cuando la m\u00e1quina rebota; el operador ajusta el ariete", "Cuando la matriz se mueve; el operador la reemplaza", "Cuando el metal regresa parcialmente a su forma original despu\u00e9s del doblez; el operador dobla un poco m\u00e1s para compensar", "Una ca\u00edda de presi\u00f3n hidr\u00e1ulica; el operador agrega fluido"]),
      mc("q6", "What do you check on a die and punch before starting a job?", ["The color and brand of the tooling", "That they are properly seated, clamped, free of cracks or chips, and matched to the job requirements", "That the ram is at maximum speed", "That the material is stored correctly"], "B", "\u00bfQu\u00e9 se verifica en la matriz y el punz\u00f3n antes de iniciar un trabajo?", ["El color y la marca de las herramientas", "Que est\u00e9n correctamente asentados, sujetados, libres de grietas o astillas, y sean los adecuados para el trabajo", "Que el ariete est\u00e9 a m\u00e1xima velocidad", "Que el material est\u00e9 almacenado correctamente"]),
      mc("q7", "What does the CNC or control panel on a press brake allow the operator to set?", ["Ram depth (bend angle), back gauge position, ram speed, and tonnage limits", "Only the bend angle", "Machine cleaning cycles", "Hydraulic oil temperature only"], "A", "\u00bfQu\u00e9 permite configurar el panel CNC o de control de una dobladora?", ["Profundidad del ariete (\u00e1ngulo), posici\u00f3n del tope trasero, velocidad del ariete y l\u00edmites de tonelaje", "Solo el \u00e1ngulo de doblez", "Ciclos de limpieza de la m\u00e1quina", "Solo la temperatura del aceite hidr\u00e1ulico"]),
      mc("q8", "What is the primary pinch point hazard on a press brake, and what must never be in that zone during operation?", ["The back gauge; feet must stay clear", "The area between the punch and die; hands and fingers must never be in the die area when the ram is descending", "The hydraulic unit; no tools near it", "The side frame; no one should stand beside it"], "B", "\u00bfCu\u00e1l es el principal peligro de atrapamiento en una dobladora y qu\u00e9 nunca debe estar en esa zona durante la operaci\u00f3n?", ["El tope trasero; los pies deben mantenerse alejados", "La zona entre el punz\u00f3n y la matriz; las manos y dedos nunca deben estar ah\u00ed cuando el ariete desciende", "La unidad hidr\u00e1ulica; no se acerquen herramientas", "El bastidor lateral; nadie debe pararse a su lado"]),
      mc("q9", "Before performing any tooling change, die swap, or maintenance on the press brake, what must the operator do?", ["Slow the ram to minimum speed", "Notify the supervisor by phone", "Apply Lockout/Tagout (LOTO) \u2014 de-energize the machine, apply personal lock and tag, and verify zero energy before working", "Put on extra gloves and proceed carefully"], "C", "Antes de realizar cualquier cambio de herramienta, cambio de matriz o mantenimiento en la dobladora, \u00bfqu\u00e9 debe hacer el operador?", ["Reducir el ariete a velocidad m\u00ednima", "Notificar al supervisor por tel\u00e9fono", "Aplicar Bloqueo/Etiquetado (LOTO): desenergizar la m\u00e1quina, aplicar su candado y etiqueta personales, y verificar cero energ\u00eda antes de trabajar", "Ponerse guantes adicionales y proceder con cuidado"]),
      mc("q10", "What PPE is required when operating the press brake?", ["Hard hat only", "Safety glasses, steel-toe boots, leather work gloves when handling material, and no loose clothing or jewelry", "Full face shield and chemical-resistant gloves only", "No PPE required for press brake operation"], "B", "\u00bfQu\u00e9 EPP se requiere al operar la dobladora?", ["Solo casco", "Lentes de seguridad, botas con puntera de acero, guantes de trabajo de cuero al manejar material, y sin ropa suelta ni joyer\u00eda", "Solo careta completa y guantes resistentes a qu\u00edmicos", "No se requiere EPP para operar dobladoras"]),
      mc("q11", "If you notice the press brake is not bending to the correct angle and you suspect a mechanical problem, what should you do?", ["Increase the tonnage and continue", "Adjust the die without stopping the machine", "Stop the machine, report the defect to your supervisor, and do not operate it until it has been inspected and cleared", "Ask a coworker to hold the material differently"], "C", "Si la dobladora no produce el \u00e1ngulo correcto y sospechas un problema mec\u00e1nico, \u00bfqu\u00e9 debes hacer?", ["Aumentar el tonelaje y continuar", "Ajustar la matriz sin detener la m\u00e1quina", "Detener la m\u00e1quina, reportar el defecto al supervisor y no operarla hasta que haya sido inspeccionada", "Pedir a un compa\u00f1ero que sostenga el material de manera diferente"]),
      mc("q12", "What is the safe way to support long or heavy material when bending on a press brake?", ["Use material support arms, roller stands, or request a second person to assist \u2014 never hold material by hand near the die zone", "Have a coworker hold the material directly over the die", "Lean the material against the machine frame", "Reduce tonnage and bend slowly by hand-guiding"], "A", "\u00bfCu\u00e1l es la forma segura de soportar material largo o pesado al doblar en la prensa?", ["Usar brazos de soporte, soportes de rodillos o pedir asistencia; nunca sostener el material con las manos cerca de la zona de la matriz", "Pedir a un compa\u00f1ero que sostenga el material directamente sobre la matriz", "Apoyar el material contra el bastidor de la m\u00e1quina", "Reducir el tonelaje y doblar guiando con las manos"]),
      mc("q13", "When is it acceptable to reach into the die area while the machine is powered on?", ["When the ram is in the raised (home) position", "When operating in inch mode at slow speed", "When a supervisor is watching", "Never \u2014 the machine must be de-energized (LOTO applied) before reaching into the die area"], "D", "\u00bfCu\u00e1ndo es aceptable meter la mano en la zona de la matriz con la m\u00e1quina energizada?", ["Cuando el ariete est\u00e1 en posici\u00f3n elevada (home)", "Cuando se opera en modo pulgada a baja velocidad", "Cuando un supervisor est\u00e1 observando", "Nunca: la m\u00e1quina debe desenergizarse (LOTO aplicado) antes de meter la mano en la zona de la matriz"]),
      mc("q14", "What does exceeding the rated tonnage of a press brake risk?", ["A louder operating noise only", "Structural damage to the machine frame, tooling failure, and risk of serious injury from broken tooling or frame", "The back gauge moving out of position", "The hydraulic fluid overheating slightly"], "B", "\u00bfQu\u00e9 riesgo implica exceder el tonelaje nominal de una dobladora?", ["Solo produce un ruido m\u00e1s fuerte", "Da\u00f1o estructural al bastidor de la m\u00e1quina, falla de herramientas y riesgo de lesiones graves por herramientas o bastidor rotos", "El tope trasero se desplaza de posici\u00f3n", "El aceite hidr\u00e1ulico se calienta ligeramente"]),
      mc("q15", "What should you do at the end of your shift before leaving the press brake?", ["Leave the ram in the down position to protect the tooling", "Return the ram to the home (up) position, power off the machine, clean the work area, and store tooling properly", "Leave the machine running for the next shift", "Remove the back gauge and store it in the office"], "B", "\u00bfQu\u00e9 debes hacer al final de tu turno antes de abandonar la dobladora?", ["Dejar el ariete en posici\u00f3n baja para proteger las herramientas", "Devolver el ariete a la posici\u00f3n de inicio (arriba), apagar la m\u00e1quina, limpiar el \u00e1rea de trabajo y almacenar las herramientas correctamente", "Dejar la m\u00e1quina encendida para el siguiente turno", "Retirar el tope trasero y guardarlo en la oficina"])
    ]
  },
  {
    ...
    rubric: competencyStages,
    questions: [
      mc("q1", "What are the three main rolls on a plate/section radius bender and what is each one's function?", ["Two feed rolls (drive the material) and one bending roll (adjusts up/down to apply curvature); their relative positions determine the radius", "Top roll (cuts), bottom roll (feeds), side roll (guides)", "Pinch roll, pressure roll, and ejector roll", "Two bending rolls and one cutting roll"], "A", "\u00bfCu\u00e1les son los tres rodillos principales de una radiadora y cu\u00e1l es la funci\u00f3n de cada uno?", ["Dos rodillos de alimentaci\u00f3n (impulsan el material) y un rodillo de doblado (sube/baja para aplicar curvatura); su posici\u00f3n relativa determina el radio", "Rodillo superior (corta), rodillo inferior (alimenta), rodillo lateral (gu\u00eda)", "Rodillo de presi\u00f3n, rodillo de apriete y rodillo expulsor", "Dos rodillos de doblado y un rodillo de corte"]),
      mc("q2", "How does the radius of the bend change when you raise or lower the center bending roll?", ["Raising the roll produces a larger (flatter) radius; lowering it has no effect", "Raising the center roll closer to the material produces a tighter (smaller) radius; lowering it away produces a larger (flatter) radius", "The roll position only affects speed, not radius", "Roll position has no effect \u2014 radius is set by machine speed"], "B", "\u00bfC\u00f3mo cambia el radio del doblez al subir o bajar el rodillo central de doblado?", ["Subir el rodillo produce un radio mayor (m\u00e1s plano); bajarlo no tiene efecto", "Subir el rodillo central hacia el material produce un radio m\u00e1s cerrado (menor); bajarlo produce un radio mayor (m\u00e1s plano)", "La posici\u00f3n del rodillo solo afecta la velocidad, no el radio", "La posici\u00f3n del rodillo no tiene efecto: el radio lo fija la velocidad de la m\u00e1quina"]),
      mc("q3", "What is the purpose of the side rolls (lateral rolls) on some radius benders?", ["To cut the material to length", "To pre-bend the straight ends of the plate and minimize flat spots at the leading and trailing edges of the workpiece", "To clamp the material during forming", "To apply lubrication to the roll surface"], "B", "\u00bfCu\u00e1l es la funci\u00f3n de los rodillos laterales en algunas radiadoras?", ["Cortar el material a la longitud indicada", "Pre-doblar los extremos rectos de la placa y minimizar zonas planas en los bordes delantero y trasero de la pieza", "Sujetar el material durante el formado", "Aplicar lubricante a la superficie de los rodillos"]),
      mc("q4", "What does 'flat spot' mean on a rolled piece, and what causes it?", ["An unbent straight section at the leading or trailing edge of the material caused by the distance between the rolls \u2014 the material end never passes over the center roll", "A dent caused by a damaged roll surface", "An area where the material surface is too smooth", "A section where the radius is too tight"], "A", "\u00bfQu\u00e9 significa 'zona plana' en una pieza rolada y qu\u00e9 la causa?", ["Una secci\u00f3n recta sin doblar en el borde delantero o trasero del material, causada por la distancia entre los rodillos: el extremo del material nunca pasa sobre el rodillo central", "Un aboll\u00f3n causado por la superficie da\u00f1ada de un rodillo", "Una zona donde la superficie del material es demasiado lisa", "Una secci\u00f3n donde el radio es demasiado cerrado"]),
      mc("q5", "What is the function of the roll release or drop-end mechanism on a radius bender?", ["To increase bending pressure at the end of the cycle", "To open one end of the roll assembly so a closed (full-circle) ring can be removed from the machine without distorting it", "To release hydraulic pressure", "To reset the roll to factory position"], "B", "\u00bfCu\u00e1l es la funci\u00f3n del mecanismo de liberaci\u00f3n de rodillo (drop-end) en una radiadora?", ["Aumentar la presi\u00f3n de doblado al final del ciclo", "Abrir un extremo del conjunto de rodillos para poder retirar un anillo cerrado (c\u00edrculo completo) sin distorsionarlo", "Liberar la presi\u00f3n hidr\u00e1ulica", "Restablecer los rodillos a la posici\u00f3n de f\u00e1brica"]),
      mc("q6", "How do you verify that the radius being produced matches the required specification?", ["By the sound the machine makes during rolling", "By using a radius gauge, template, or tape measure to check the arc against the drawing specification \u2014 checking during and after rolling", "By the number shown on the roll position counter only", "By estimating visually from a distance"], "B", "\u00bfC\u00f3mo se verifica que el radio producido corresponde a la especificaci\u00f3n requerida?", ["Por el sonido que hace la m\u00e1quina durante el rolado", "Usando un calibrador de radio, plantilla o cinta m\u00e9trica para comparar el arco con la especificaci\u00f3n del plano, durante y despu\u00e9s del rolado", "Solo por el n\u00famero que muestra el contador de posici\u00f3n del rodillo", "Estimando visualmente desde lejos"]),
      mc("q7", "What happens to the required roll setting if the material is thicker or has higher yield strength than previously run?", ["The center roll must be raised higher (more pressure) to achieve the same radius because thicker/harder material resists bending more and has greater springback", "No change needed \u2014 roll settings are the same for all materials", "The machine speed must be reduced only", "The side rolls must be removed"], "A", "\u00bfQu\u00e9 sucede con la configuraci\u00f3n requerida del rodillo si el material es m\u00e1s grueso o tiene mayor l\u00edmite el\u00e1stico que el material rolado anteriormente?", ["El rodillo central debe subirse m\u00e1s (m\u00e1s presi\u00f3n) para lograr el mismo radio, porque el material m\u00e1s grueso/duro resiste m\u00e1s el doblado y tiene mayor retorno el\u00e1stico", "No es necesario cambiar nada: las configuraciones son iguales para todos los materiales", "Solo debe reducirse la velocidad de la m\u00e1quina", "Deben retirarse los rodillos laterales"]),
      mc("q8", "What is the most critical hand/body safety rule when feeding material into the radius bender rolls?", ["Hands must never follow the material into the nip (pinch) point between the rolls \u2014 always release the material before it reaches the roll entry point", "Always keep one hand on the roll control while feeding with the other", "Feed the material using both hands pushed flat against the plate surface", "Gloves should not be worn to feel the material better"], "A", "\u00bfCu\u00e1l es la regla de seguridad m\u00e1s importante para manos/cuerpo al introducir material en los rodillos de la radiadora?", ["Las manos nunca deben seguir el material hacia el punto de pellizco (nip) entre los rodillos: siempre soltar el material antes de que llegue al punto de entrada del rodillo", "Mantener siempre una mano en el control del rodillo mientras se alimenta con la otra", "Alimentar el material con ambas manos apoyadas planas sobre la superficie de la placa", "No usar guantes para sentir mejor el material"]),
      mc("q9", "What PPE is required when operating the radius bender?", ["Chemical-resistant gloves and face shield only", "Safety glasses, steel-toe boots, leather work gloves for material handling, and no loose clothing, rings, or jewelry", "Hard hat and hearing protection only", "No PPE required \u2014 rolls move slowly"], "B", "\u00bfQu\u00e9 EPP se requiere al operar la radiadora?", ["Solo guantes resistentes a qu\u00edmicos y careta", "Lentes de seguridad, botas con puntera de acero, guantes de trabajo de cuero al manejar material, y sin ropa suelta, anillos ni joyer\u00eda", "Solo casco y protecci\u00f3n auditiva", "No se requiere EPP: los rodillos se mueven despacio"]),
      mc("q10", "Before changing roll tooling or clearing a jam on the radius bender, what must the operator do?", ["Stop the rolls and reach in quickly", "Apply full Lockout/Tagout \u2014 shut down, apply personal lock and tag, verify zero energy state before any contact with the machine", "Set the machine to its slowest speed setting", "Ask a coworker to hold the e-stop while you reach in"], "B", "Antes de cambiar herramientas de rodillos o despejar un atasco en la radiadora, \u00bfqu\u00e9 debe hacer el operador?", ["Detener los rodillos y meter la mano r\u00e1pidamente", "Aplicar Bloqueo/Etiquetado completo: apagar la m\u00e1quina, aplicar candado y etiqueta personal en la fuente de energ\u00eda, y verificar estado de cero energ\u00eda antes de cualquier contacto con la m\u00e1quina", "Poner la m\u00e1quina en su configuraci\u00f3n de velocidad m\u00e1s baja", "Pedir a un compa\u00f1ero que sostenga el bot\u00f3n de paro mientras se mete la mano"]),
      mc("q11", "When rolling a long plate or beam section, what is required to prevent the free end from becoming a hazard?", ["Support the free end with a roller stand or material support, and ensure the area around the machine is clear of other workers \u2014 the swinging end can cause serious injury", "Have a coworker hold the free end by hand", "Run the material at high speed so the free end does not droop", "Bend only short pieces on this machine"], "A", "Al rolar una placa larga o secci\u00f3n de viga, \u00bfqu\u00e9 se requiere para evitar que el extremo libre se convierta en un peligro?", ["Soportar el extremo libre con un soporte de rodillos o soporte de material, y asegurar que el \u00e1rea alrededor de la m\u00e1quina est\u00e9 despejada de otros trabajadores: el extremo que gira puede causar lesiones graves", "Pedir a un compa\u00f1ero que sostenga el extremo libre con las manos", "Operar el material a alta velocidad para que el extremo libre no se cuelgue", "Solo doblar piezas cortas en esta m\u00e1quina"]),
      mc("q12", "Why is it dangerous to attempt to bend material that exceeds the machine's rated capacity?", ["The machine will produce a slightly inaccurate radius", "It can cause roll shaft failure, bearing damage, or structural failure of the machine frame, creating serious injury risk from sudden mechanical failure", "The rolls will spin faster than expected", "The material will scratch the roll surface only"], "B", "\u00bfPor qu\u00e9 es peligroso intentar doblar material que excede la capacidad nominal de la m\u00e1quina?", ["La m\u00e1quina producir\u00e1 un radio ligeramente impreciso", "Puede causar falla del eje del rodillo, da\u00f1o en cojinetes o falla estructural del bastidor, creando riesgo grave de lesi\u00f3n por falla mec\u00e1nica repentina", "Los rodillos girar\u00e1n m\u00e1s r\u00e1pido de lo esperado", "Solo rayar\u00e1 la superficie del rodillo"]),
      mc("q13", "If the rolled piece comes out with a kink or crease, what should the operator do?", ["Increase roll pressure and run it through again immediately", "Stop the machine, report the defect to the supervisor, and do not attempt repairs or adjustments without authorization", "Continue rolling \u2014 kinks will flatten out over multiple passes", "Use a hammer to remove the kink manually"], "B", "Si la pieza rolada presenta una arruga o pliegue, \u00bfqu\u00e9 debe hacer el operador?", ["Aumentar la presi\u00f3n del rodillo y pasar el material de nuevo de inmediato", "Detener la m\u00e1quina, reportar el defecto al supervisor y no intentar reparaciones o ajustes sin autorizaci\u00f3n", "Continuar rolando: las arrugas se aplanar\u00e1n en varias pasadas", "Usar un martillo para eliminar la arruga manualmente"]),
      mc("q14", "What must you do to ensure the roll surface does not damage the material finish or cause uneven forming?", ["Inspect rolls for nicks, pitting, debris, or buildup before starting, and clean rolls as needed \u2014 contamination on rolls transfers marks to material", "Apply heavy oil to the material before feeding", "Run the machine at maximum speed to minimize contact time", "Roll surface condition does not affect the finished part"], "A", "\u00bfQu\u00e9 debes hacer para asegurar que la superficie del rodillo no da\u00f1e el acabado del material ni cause formado irregular?", ["Inspeccionar los rodillos para detectar muescas, picaduras, residuos o acumulaciones antes de iniciar, y limpiarlos seg\u00fan sea necesario: la contaminaci\u00f3n en los rodillos se transfiere al material", "Aplicar aceite abundante al material antes de alimentarlo", "Operar la m\u00e1quina a m\u00e1xima velocidad para minimizar el tiempo de contacto", "La condici\u00f3n de la superficie del rodillo no afecta la pieza terminada"]),
      mc("q15", "What should you always do before walking away from the radius bender at the end of your shift?", ["Leave material loaded in the rolls for the next operator", "Remove all material from the rolls, return rolls to open position, power off the machine, and clean the work area", "Lower the center roll to maximum down position", "Leave the machine running at low speed to keep rolls warm"], "B", "\u00bfQu\u00e9 debes hacer siempre antes de alejarte de la radiadora al final de tu turno?", ["Dejar material cargado en los rodillos para el siguiente operador", "Retirar todo el material de los rodillos, devolver los rodillos a la posici\u00f3n abierta, apagar la m\u00e1quina y limpiar el \u00e1rea de trabajo", "Bajar el rodillo central a la posici\u00f3n m\u00e1xima abajo", "Dejar la m\u00e1quina encendida a baja velocidad para mantener los rodillos calientes"])
    ]
  },
  {
    ...
    rubric: competencyStages,
    questions: [
      mc("q1", "What are the two main cutting blades on a hydraulic shear and how do they produce the cut?", ["The upper moving blade (ram blade) descends to meet the fixed lower blade (bed blade); the shearing action separates the material between them", "Two rotating saw blades that cut from opposite sides", "A punch and die set that stamps through the material", "Two horizontal blades that squeeze the material from both sides"], "A", "\u00bfCu\u00e1les son las dos cuchillas principales de una Guillotina hidr\u00e1ulica y c\u00f3mo producen el corte?", ["La cuchilla superior m\u00f3vil (ariete) desciende para encontrarse con la cuchilla inferior fija (de la mesa); la acci\u00f3n de Guillotinamiento separa el material entre ellas", "Dos hojas de sierra rotativas que cortan desde lados opuestos", "Un juego de punz\u00f3n y dado que estampa el material", "Dos cuchillas horizontales que comprimen el material desde ambos lados"]),
      mc("q2", "What is the purpose of the hold-down clamps (material clamps) on a hydraulic shear?", ["To guide the blade during the cut", "To clamp and secure the sheet firmly to the bed just before and during the cut, preventing movement, buckling, or lifting of the material", "To measure the sheet length automatically", "To return the blade to home position after each cut"], "B", "\u00bfCu\u00e1l es la funci\u00f3n de las prensas de sujeci\u00f3n (prensa-chapas) en una Guillotina hidr\u00e1ulica?", ["Guiar la cuchilla durante el corte", "Sujetar y asegurar firmemente la varilla contra la mesa justo antes y durante el corte, evitando el movimiento, el pandeo o el levantamiento del material", "Medir la longitud de la varilla autom\u00e1ticamente", "Devolver la cuchilla a la posici\u00f3n de inicio despu\u00e9s de cada corte"]),
      mc("q3", "What is the back gauge on a shear line and what does it control?", ["An adjustable stop behind the blade that the material is pushed against to set the cut-off dimension \u2014 controls the width of the piece being cut", "A sensor that counts the number of cuts made", "A clamp that holds the material from the rear", "A safety guard mounted behind the machine"], "A", "\u00bfQu\u00e9 es el tope trasero en una l\u00ednea de Guillotina y qu\u00e9 controla?", ["Un tope ajustable detr\u00e1s de la cuchilla contra el que se empuja el material para fijar la dimensi\u00f3n de corte: controla el ancho de la pieza que se va a cortar", "Un sensor que cuenta el n\u00famero de cortes realizados", "Una grapa que sostiene el material por la parte trasera", "Un protector de seguridad montado detr\u00e1s de la m\u00e1quina"]),
      mc("q4", "What is 'blade clearance' (blade gap) on a shear and why does it matter?", ["The horizontal gap between the upper and lower blades; it must be set proportional to material thickness \u2014 incorrect clearance causes poor cut quality, burrs, or blade damage", "The vertical travel distance of the upper blade", "The space between the blade and the back gauge", "A safety gap for operator fingers"], "A", "\u00bfQu\u00e9 es la 'holgura de cuchilla' (juego) en una Guillotina y por qu\u00e9 importa?", ["La separaci\u00f3n horizontal entre la cuchilla superior e inferior; debe ajustarse proporcionalmente al grosor del material: una holgura incorrecta causa mala calidad de corte, rebabas o da\u00f1o a la cuchilla", "La distancia vertical de recorrido de la cuchilla superior", "El espacio entre la cuchilla y el tope trasero", "Un espacio de seguridad para los dedos del operador"]),
      mc("q5", "What is the 'rake angle' on a shear blade and what is its purpose?", ["The angle of the blade edge after sharpening", "The angle at which the upper blade is tilted relative to the lower blade \u2014 it creates a progressive shearing action from one side to the other, reducing cutting force required", "The tilt of the shear bed for material feeding", "The angle at which scrap falls away from the blade"], "B", "\u00bfQu\u00e9 es el '\u00e1ngulo de inclinaci\u00f3n' (rake angle) de una cuchilla de Guillotina y cu\u00e1l es su prop\u00f3sito?", ["El \u00e1ngulo del filo de la cuchilla despu\u00e9s del afilado", "El \u00e1ngulo en que la cuchilla superior est\u00e1 inclinada con respecto a la inferior: crea una acci\u00f3n de Guillotinamiento progresiva de un lado al otro, reduciendo la fuerza de corte requerida", "La inclinaci\u00f3n de la mesa de la Guillotina para la alimentaci\u00f3n del material", "El \u00e1ngulo en que la chatarra cae alej\u00e1ndose de la cuchilla"]),
      mc("q6", "How do you know when a shear blade needs to be rotated or replaced?", ["When cuts show excessive burrs, rollover (bent-over edges), or ragged cut lines \u2014 signs of a dull blade edge that requires rotation to an unused edge or blade replacement", "After every 10 cuts regardless of condition", "When the machine makes more noise than usual", "Only when the blade visibly cracks"], "A", "\u00bfC\u00f3mo saber cu\u00e1ndo una cuchilla de Guillotina necesita rotarse o reemplazarse?", ["Cuando los cortes presentan rebabas excesivas, vuelta de borde (bordes doblados) o l\u00edneas de corte irregulares: se\u00f1ales de un filo desgastado que requiere rotar a un filo sin uso o reemplazar la cuchilla", "Despu\u00e9s de cada 10 cortes sin importar la condici\u00f3n", "Cuando la m\u00e1quina hace m\u00e1s ruido de lo habitual", "Solo cuando la cuchilla se agrieta visiblemente"]),
      mc("q7", "What does the squaring arm / front gauge on a shear line help the operator do?", ["Control the ram speed", "Align the material at 90 degrees to the blade to ensure a square cut \u2014 used when the cut edge must be perpendicular to the sheet edge", "Measure the blade gap", "Hold the scrap piece after cutting"], "B", "\u00bfPara qu\u00e9 sirve el brazo cuadrador / tope delantero en una l\u00ednea de Guillotina?", ["Controlar la velocidad del ariete", "Alinear el material a 90 grados con respecto a la cuchilla para garantizar un corte en escuadra: se usa cuando el borde cortado debe ser perpendicular al borde de la varilla", "Medir la holgura de la cuchilla", "Sostener la pieza de chatarra despu\u00e9s del corte"]),
      mc("q8", "What is the most severe hazard of a hydraulic shear and what guard protects against it?", ["The descending upper blade \u2014 the front safety guard/finger guard must be in place and functional before every cut; it prevents hands and fingers from reaching the blade zone", "Hydraulic fluid overheating \u2014 the pressure relief valve is the guard", "Material sliding off the table \u2014 side stops are the guard", "Back gauge impact \u2014 a rubber bumper is the guard"], "A", "\u00bfCu\u00e1l es el peligro m\u00e1s grave de una Guillotina hidr\u00e1ulica y qu\u00e9 protector lo previene?", ["La cuchilla superior descendente: el protector frontal de seguridad/protector de dedos debe estar en su lugar y funcional antes de cada corte; evita que manos y dedos alcancen la zona de la cuchilla", "El sobrecalentamiento del aceite hidr\u00e1ulico: la v\u00e1lvula de alivio de presi\u00f3n es el protector", "El material desliz\u00e1ndose de la mesa: los topes laterales son el protector", "El impacto del tope trasero: un tope de goma es el protector"]),
      mc("q9", "What must the operator NEVER do while the shear blade is in motion or the foot pedal / hand control is being activated?", ["Place hands or any body part in front of the blade or inside the cutting zone \u2014 this includes adjusting material position, retrieving scrap, or clearing pieces while the ram can cycle", "Look at the back gauge reading", "Stand to the side of the machine", "Keep both feet on the floor"], "A", "\u00bfQu\u00e9 NUNCA debe hacer el operador mientras la cuchilla de la Guillotina est\u00e1 en movimiento o se est\u00e1 activando el pedal/control de mano?", ["Colocar manos o cualquier parte del cuerpo frente a la cuchilla o dentro de la zona de corte: esto incluye ajustar la posici\u00f3n del material, recuperar chatarra o despejar piezas mientras el ariete puede ciclar", "Mirar la lectura del tope trasero", "Pararse a un lado de la m\u00e1quina", "Mantener ambos pies en el suelo"]),
      mc("q10", "What PPE is required when operating the shear line?", ["Hard hat and ear protection only", "Safety glasses, steel-toe boots, leather work gloves when handling sheet metal, and no loose clothing, rings, or jewelry", "Chemical-resistant gloves and respirator", "No PPE required for light gauge material"], "B", "\u00bfQu\u00e9 EPP se requiere al operar la l\u00ednea de Guillotina?", ["Solo casco y protecci\u00f3n auditiva", "Lentes de seguridad, botas con puntera de acero, guantes de trabajo de cuero al manejar varilla met\u00e1lica, y sin ropa suelta, anillos ni joyer\u00eda", "Solo guantes resistentes a qu\u00edmicos y respirador", "No se requiere EPP para material de calibre ligero"]),
      mc("q11", "Before performing blade rotation, blade replacement, or any maintenance on the shear, what is mandatory?", ["Lower the blade to the bed position and proceed", "Apply full Lockout/Tagout \u2014 shut down the machine, apply personal lock and tag to the energy source, and verify zero energy state before touching the blade or any internal component", "Have a coworker hold the foot pedal up while you rotate the blade", "Switch the machine to maintenance mode on the control panel and proceed"], "B", "Antes de realizar la rotaci\u00f3n de cuchilla, el reemplazo de cuchilla o cualquier mantenimiento en la Guillotina, \u00bfqu\u00e9 es obligatorio?", ["Bajar la cuchilla a la posici\u00f3n de la mesa y proceder", "Aplicar Bloqueo/Etiquetado completo: apagar la m\u00e1quina, aplicar candado y etiqueta personal en la fuente de energ\u00eda, y verificar el estado de cero energ\u00eda antes de tocar la cuchilla o cualquier componente interno", "Pedir a un compa\u00f1ero que sostenga el pedal hacia arriba mientras se rota la cuchilla", "Cambiar la m\u00e1quina al modo de mantenimiento en el panel de control y proceder"]),
      mc("q12", "How should a second operator or helper be positioned when assisting with a large sheet on the shear line?", ["Supporting the sheet from the side or rear \u2014 never in front of or reaching over the blade line; only the primary operator activates the cut control", "Standing directly in front of the blade to guide the material edge", "Holding the foot pedal ready as a backup", "Positioned behind the back gauge"], "A", "\u00bfC\u00f3mo debe posicionarse un segundo operador o ayudante cuando asiste con una varilla grande en la l\u00ednea de Guillotina?", ["Soportando la varilla desde un lado o la parte trasera, nunca frente a la l\u00ednea de la cuchilla ni estir\u00e1ndose sobre ella; solo el operador principal activa el control de corte", "Par\u00e1ndose directamente frente a la cuchilla para guiar el borde del material", "Sosteniendo el pedal listo como respaldo", "Posicionado detr\u00e1s del tope trasero"]),
      mc("q13", "What should the operator do if the shear guard is missing, damaged, or not functioning correctly?", ["Continue operating carefully at reduced speed", "Stop operation immediately, tag the machine out of service, and report to the supervisor \u2014 machines must not be operated without functional guards", "Tape a warning sign near the blade area and continue", "Ask a coworker to watch the blade area while you cut"], "B", "\u00bfQu\u00e9 debe hacer el operador si el protector de la Guillotina est\u00e1 faltante, da\u00f1ado o no funciona correctamente?", ["Continuar operando cuidadosamente a velocidad reducida", "Detener la operaci\u00f3n de inmediato, etiquetar la m\u00e1quina fuera de servicio y reportar al supervisor: las m\u00e1quinas no deben operarse sin protectores funcionales", "Colocar una se\u00f1al de advertencia cerca de la zona de la cuchilla y continuar", "Pedir a un compa\u00f1ero que vigile la zona de la cuchilla mientras se corta"]),
      mc("q14", "What is the correct way to handle and stack freshly cut sheet metal pieces after shearing?", ["Use leather gloves at all times \u2014 freshly sheared edges are razor-sharp; stack pieces flat and stably, do not lean them unsupported against walls or machines", "Grab pieces bare-handed on the cut edge to test sharpness", "Stack pieces vertically leaning against the shear frame", "Toss pieces into the scrap bin to keep the area clear"], "A", "\u00bfCu\u00e1l es la forma correcta de manejar y apilar las piezas de varilla reci\u00e9n cortadas despu\u00e9s del Guillotinado?", ["Usar siempre guantes de cuero: los bordes reci\u00e9n Guillotinados son como navaja; apilar las piezas planas y establemente, no apoyarlas contra paredes ni m\u00e1quinas sin soporte", "Tomar las piezas con las manos desnudas por el borde cortado para probar su filo", "Apilar las piezas verticalmente apoyadas contra el bastidor de la Guillotina", "Lanzar las piezas al contenedor de chatarra para mantener el \u00e1rea despejada"]),
      mc("q15", "What should you do at the end of your shift on the shear line?", ["Leave the ram in the down position so the blade is protected", "Return the ram to the home (up) position, power off the machine, remove all material from the table, clean the area of scrap and metal chips, and store any tooling properly", "Leave the last piece of material clamped under the hold-downs", "Leave the machine on standby for the next shift"], "B", "\u00bfQu\u00e9 debes hacer al final de tu turno en la l\u00ednea de Guillotina?", ["Dejar el ariete en posici\u00f3n baja para que la cuchilla quede protegida", "Devolver el ariete a la posici\u00f3n de inicio (arriba), apagar la m\u00e1quina, retirar todo el material de la mesa, limpiar el \u00e1rea de chatarra y esquirlas met\u00e1licas, y guardar las herramientas correctamente", "Dejar la \u00faltima pieza sujeta bajo las prensas de sujeci\u00f3n", "Dejar la m\u00e1quina en espera para el siguiente turno"])
    ]
  },
  {
    id: "bender-helper",
    category: "Machine helper",
    title: "Press Brake Helper Safety Knowledge",
    equipment: "Bender / Press Brake",
    role: "Machine Helper",
    description: "Covers helper positioning, machine-control boundaries, PPE, material handling, communication with the operator, and when to stop work.",
    rubric: competencyStages.map((stage) => ({ ...stage, title: stage.title.replace("Machine-Specific", "Helper Task") })),
    questions: [
      mc("q1", "As a helper at the press brake, where must you NEVER position your hands or body during a bend cycle?", ["Behind the back gauge", "In the area between the punch and die, or anywhere near the die zone when the ram is moving", "To the side of the machine bed", "Near the foot pedal"], "B", "Como ayudante en la dobladora, \u00bfd\u00f3nde NUNCA debes colocar tus manos o cuerpo durante un ciclo de doblez?", ["Detr\u00e1s del tope trasero", "En la zona entre el punz\u00f3n y la matriz, o en cualquier lugar cerca de la zona de la matriz cuando el ariete est\u00e1 en movimiento", "A un lado de la mesa de la m\u00e1quina", "Cerca del pedal de operaci\u00f3n"]),
      mc("q2", "Who is the only person authorized to activate the press brake foot pedal or hand control?", ["Either the operator or the helper, whoever is ready first", "The helper, to free up the operator's hands", "The primary operator only \u2014 helpers never activate the machine controls", "The supervisor on duty"], "C", "\u00bfQui\u00e9n es la \u00fanica persona autorizada para activar el pedal o el control de mano de la dobladora?", ["El operador o el ayudante, quien est\u00e9 listo primero", "El ayudante, para liberar las manos del operador", "Solo el operador principal: los ayudantes nunca activan los controles de la m\u00e1quina", "El supervisor de turno"]),
      mc("q3", "When the operator signals you to support a long piece of material, where should your hands be positioned?", ["As close to the punch as possible to keep the sheet steady", "Supporting the material from the outfeed side, well away from the die zone \u2014 never in front of or over the punch-die area", "On top of the material near the bend line for best control", "Underneath the material directly below the punch"], "B", "Cuando el operador te indica que soporte una pieza larga de material, \u00bfd\u00f3nde deben estar posicionadas tus manos?", ["Lo m\u00e1s cerca posible del punz\u00f3n para mantener la l\u00e1mina estable", "Soportando el material desde el lado de salida, bien alejadas de la zona de la matriz: nunca frente ni sobre la zona punz\u00f3n-matriz", "Encima del material cerca de la l\u00ednea de doblez para mayor control", "Debajo del material directamente bajo el punz\u00f3n"]),
      mc("q4", "If you need to reposition the material on the press brake bed, when is it safe to do so?", ["Anytime \u2014 just be quick", "While the ram is returning to home position", "Only after the ram has returned to the full home position AND the operator confirms it is safe to adjust", "While the operator is looking at the control panel"], "C", "Si necesitas reposicionar el material en la mesa de la dobladora, \u00bfcu\u00e1ndo es seguro hacerlo?", ["En cualquier momento, solo hazlo r\u00e1pido", "Mientras el ariete regresa a la posici\u00f3n de inicio", "Solo despu\u00e9s de que el ariete haya regresado completamente a la posici\u00f3n de inicio Y el operador confirme que es seguro ajustar", "Mientras el operador est\u00e1 mirando el panel de control"]),
      mc("q5", "What PPE is required for a helper working at the press brake?", ["No PPE required \u2014 helpers do not operate the machine", "Safety glasses, steel-toe boots, and leather work gloves when handling material; no loose clothing, rings, or jewelry", "Only a hard hat", "Only hearing protection"], "B", "\u00bfQu\u00e9 EPP se requiere para un ayudante que trabaja en la dobladora?", ["No se requiere EPP: los ayudantes no operan la m\u00e1quina", "Lentes de seguridad, botas con puntera de acero y guantes de trabajo de cuero al manejar material; sin ropa suelta, anillos ni joyer\u00eda", "Solo casco", "Solo protecci\u00f3n auditiva"]),
      mc("q6", "As a helper, what should you do if you notice a crack, chip, or abnormality on the punch or die before the shift starts?", ["Ignore it \u2014 tooling inspection is only the operator's responsibility", "Report it immediately to the operator and supervisor before the machine is used", "Try to fix it yourself with available tools", "Cover it with tape and continue"], "B", "Como ayudante, \u00bfqu\u00e9 debes hacer si notas una grieta, astilla o anomal\u00eda en el punz\u00f3n o la matriz antes de iniciar el turno?", ["Ignorarlo: la inspecci\u00f3n de herramientas es solo responsabilidad del operador", "Reportarlo de inmediato al operador y al supervisor antes de que se use la m\u00e1quina", "Intentar repararlo t\u00fa mismo con las herramientas disponibles", "Cubrirlo con cinta adhesiva y continuar"]),
      mc("q7", "When stacking or moving finished bent parts, what is the correct procedure?", ["Stack them as fast as possible in any available space", "Use leather gloves \u2014 bent sheet metal edges are sharp; stack pieces flat and stably in the designated area", "Stack pieces vertically leaning against the machine frame", "Drop parts into the nearest bin without inspecting them"], "B", "Al apilar o mover piezas dobladas terminadas, \u00bfcu\u00e1l es el procedimiento correcto?", ["Apilarlas lo m\u00e1s r\u00e1pido posible en cualquier espacio disponible", "Usar guantes de cuero: los bordes de l\u00e1mina doblada son cortantes; apilar las piezas planas y establemente en el \u00e1rea designada", "Apilar las piezas verticalmente apoyadas contra el bastidor de la m\u00e1quina", "Lanzar las piezas al contenedor m\u00e1s cercano sin inspeccionarlas"]),
      mc("q8", "What does it mean if the operator raises their hand or calls out 'stop' while you are handling material?", ["They need you to speed up", "Stop all movement immediately and wait for further instruction \u2014 the operator may have detected a hazard", "Finish what you are doing first, then stop", "It is a signal to activate the machine"], "B", "\u00bfQu\u00e9 significa si el operador levanta la mano o grita 'alto' mientras est\u00e1s manejando material?", ["Que necesita que te apures", "Detener todo movimiento de inmediato y esperar instrucciones: el operador puede haber detectado un peligro", "Terminar lo que est\u00e1s haciendo y luego detenerte", "Es una se\u00f1al para activar la m\u00e1quina"]),
      mc("q9", "As a helper, are you allowed to adjust the back gauge or make any machine settings on the press brake?", ["Yes, if the operator asks you to", "Yes, anytime to help speed up production", "No \u2014 machine settings, back gauge adjustments, and controls are the operator's responsibility only", "Only if no supervisor is present"], "C", "Como ayudante, \u00bftienes permitido ajustar el tope trasero o realizar configuraciones en la dobladora?", ["S\u00ed, si el operador te lo pide", "S\u00ed, en cualquier momento para ayudar a acelerar la producci\u00f3n", "No: las configuraciones de la m\u00e1quina, ajustes del tope trasero y controles son responsabilidad exclusiva del operador", "Solo si no hay supervisor presente"]),
      mc("q10", "What should you do if a piece of material falls or slips while being handled near the press brake?", ["Reach in quickly to catch it before it hits the machine", "Let it fall \u2014 never reach into the machine area to catch a falling piece; step back and alert the operator", "Try to kick it away from the machine", "Grab the nearest person to help immediately"], "B", "\u00bfQu\u00e9 debes hacer si una pieza de material cae o se desliza mientras se maneja cerca de la dobladora?", ["Meter la mano r\u00e1pidamente para atraparla antes de que golpee la m\u00e1quina", "Dejarla caer: nunca metas la mano en la zona de la m\u00e1quina para atrapar una pieza que cae; retrocede y alerta al operador", "Intentar detenerla con el pie", "Agarrar a la persona m\u00e1s cercana para que ayude de inmediato"])
    ]
  },
  {
    id: "radius-bender-helper",
    category: "Machine helper",
    title: "Radius Bender Helper Safety Knowledge",
    equipment: "Radius Bender",
    role: "Machine Helper",
    description: "Covers helper positioning, machine-control boundaries, PPE, material handling, communication with the operator, and when to stop work.",
    rubric: competencyStages.map((stage) => ({ ...stage, title: stage.title.replace("Machine-Specific", "Helper Task") })),
    questions: [
      mc("q1", "As a helper at the radius bender, where must your hands NEVER be when the rolls are turning?", ["On the outfeed side of the machine", "Near or in the nip (pinch) point between any of the rolls \u2014 hands must stay well clear of all roll entry points while the machine is running", "On the side frame of the machine", "Near the control panel"], "B", "Como ayudante en la radiadora, \u00bfd\u00f3nde NUNCA deben estar tus manos cuando los rodillos est\u00e1n girando?", ["En el lado de salida de la m\u00e1quina", "Cerca o dentro del punto de pellizco entre cualquiera de los rodillos: las manos deben mantenerse bien alejadas de todos los puntos de entrada de los rodillos mientras la m\u00e1quina est\u00e1 en marcha", "En el bastidor lateral de la m\u00e1quina", "Cerca del panel de control"]),
      mc("q2", "When supporting the leading end of a long plate being rolled, how far should you stand from the rolls?", ["As close as possible to guide the plate precisely into the rolls", "At a safe distance on the outfeed side, supporting the weight of the material without pulling or pushing it toward the rolls", "Directly in front of the roll entry point", "Behind the machine near the back panel"], "B", "Al soportar el extremo delantero de una placa larga que se est\u00e1 rolando, \u00bfa qu\u00e9 distancia debes pararte de los rodillos?", ["Lo m\u00e1s cerca posible para guiar la placa con precisi\u00f3n hacia los rodillos", "A una distancia segura en el lado de salida, soportando el peso del material sin jalar ni empujarlo hacia los rodillos", "Directamente frente al punto de entrada de los rodillos", "Detr\u00e1s de la m\u00e1quina cerca del panel trasero"]),
      mc("q3", "Who controls the roll speed and direction during a rolling operation?", ["The helper, to keep pace with the material movement", "Either person \u2014 whoever reacts first", "The primary operator only \u2014 the helper never touches the controls", "Both the operator and helper simultaneously"], "C", "\u00bfQui\u00e9n controla la velocidad y direcci\u00f3n de los rodillos durante una operaci\u00f3n de rolado?", ["El ayudante, para mantener el ritmo con el movimiento del material", "Cualquiera de los dos: quien reaccione primero", "Solo el operador principal: el ayudante nunca toca los controles", "El operador y el ayudante simult\u00e1neamente"]),
      mc("q4", "What PPE is required for a helper working at the radius bender?", ["No PPE \u2014 helpers only carry parts", "Safety glasses, steel-toe boots, and leather work gloves when handling material; no loose clothing, rings, or jewelry", "Only a hard hat and hearing protection", "Only steel-toe boots"], "B", "\u00bfQu\u00e9 EPP se requiere para un ayudante que trabaja en la radiadora?", ["No se requiere EPP: los ayudantes solo cargan piezas", "Lentes de seguridad, botas con puntera de acero y guantes de trabajo de cuero al manejar material; sin ropa suelta, anillos ni joyer\u00eda", "Solo casco y protecci\u00f3n auditiva", "Solo botas con puntera de acero"]),
      mc("q5", "When a long section is being rolled and the free end begins to swing outward, what should the helper do?", ["Grab the swinging end with bare hands immediately", "Stand in the path of the swinging end to stop it", "Support the free end using the designated material support stand \u2014 never allow it to swing freely near personnel", "Walk away and let it fall"], "C", "Cuando una secci\u00f3n larga se est\u00e1 rolando y el extremo libre comienza a girar hacia afuera, \u00bfqu\u00e9 debe hacer el ayudante?", ["Agarrar el extremo que gira con las manos desnudas de inmediato", "Pararse en la trayectoria del extremo que gira para detenerlo", "Soportar el extremo libre usando el soporte de material designado: nunca permitir que gire libremente cerca del personal", "Alejarse y dejar que caiga"]),
      mc("q6", "If the rolled piece develops a kink or crease mid-operation, what should the helper do?", ["Continue supporting the material and say nothing", "Signal the operator to stop immediately and report the defect before continuing", "Try to straighten the kink by hand while the rolls are moving", "Increase how hard you are supporting the material"], "B", "Si la pieza rolada desarrolla una arruga o pliegue durante la operaci\u00f3n, \u00bfqu\u00e9 debe hacer el ayudante?", ["Continuar soportando el material y no decir nada", "Se\u00f1alar al operador que detenga la m\u00e1quina de inmediato y reportar el defecto antes de continuar", "Intentar enderezar la arruga con la mano mientras los rodillos est\u00e1n en movimiento", "Aumentar la fuerza con la que soportas el material"]),
      mc("q7", "What should a helper do before the start of a rolling job to help ensure safe operation?", ["Inspect the rolls for surface damage, debris, or buildup and report findings to the operator", "Adjust the center roll position to match the job", "Start the machine and test the speed", "Nothing \u2014 pre-shift checks are only the operator's job"], "A", "\u00bfQu\u00e9 debe hacer el ayudante antes de iniciar un trabajo de rolado para contribuir a una operaci\u00f3n segura?", ["Inspeccionar los rodillos para detectar da\u00f1os en la superficie, residuos o acumulaciones y reportar los hallazgos al operador", "Ajustar la posici\u00f3n del rodillo central seg\u00fan el trabajo", "Arrancar la m\u00e1quina y probar la velocidad", "Nada: las revisiones pre-turno son solo responsabilidad del operador"]),
      mc("q8", "When finished parts (rolled rings or arcs) are removed from the machine, how should a helper handle and stack them?", ["Grab edges bare-handed and stack them standing upright against the wall", "Use leather gloves; lay pieces flat and stably in the designated area \u2014 rolled edges can be sharp and pieces can roll or tip over", "Toss pieces onto the floor near the machine", "Stack them as high as possible to save floor space"], "B", "Cuando se retiran piezas terminadas (anillos o arcos rolados) de la m\u00e1quina, \u00bfc\u00f3mo debe manejarlas y apilarlas el ayudante?", ["Agarrar los bordes con las manos desnudas y apilarlas verticalmente contra la pared", "Usar guantes de cuero; colocar las piezas planas y establemente en el \u00e1rea designada: los bordes rolados pueden ser cortantes y las piezas pueden rodar o voltearse", "Lanzar las piezas al suelo cerca de la m\u00e1quina", "Apilarlas lo m\u00e1s alto posible para ahorrar espacio en el piso"]),
      mc("q9", "As a helper, are you allowed to clear a jam or adjust tooling on the radius bender without instruction?", ["Yes, if you can see the problem clearly", "Yes, if the operator is busy", "No \u2014 all jams and tooling work require full LOTO; only authorized personnel may perform these tasks", "Yes, if the machine is stopped"], "C", "Como ayudante, \u00bftienes permitido despejar un atasco o ajustar herramientas en la radiadora sin instrucciones?", ["S\u00ed, si puedes ver claramente el problema", "S\u00ed, si el operador est\u00e1 ocupado", "No: todos los atascos y trabajos de herramientas requieren LOTO completo; solo el personal autorizado puede realizar estas tareas", "S\u00ed, si la m\u00e1quina est\u00e1 detenida"]),
      mc("q10", "What should a helper do if they are not sure whether it is safe to approach the machine during a rolling operation?", ["Approach slowly and check for yourself", "Wait at a safe distance and make eye contact with the operator before approaching \u2014 never approach a running machine without the operator's awareness", "Tap the operator on the shoulder while they are operating", "Walk up to the machine and stop it yourself"], "B", "\u00bfQu\u00e9 debe hacer el ayudante si no est\u00e1 seguro de si es seguro acercarse a la m\u00e1quina durante una operaci\u00f3n de rolado?", ["Acercarse despacio y verificar por s\u00ed mismo", "Esperar a una distancia segura y hacer contacto visual con el operador antes de acercarse: nunca te acerques a una m\u00e1quina en marcha sin que el operador lo sepa", "Tocar al operador en el hombro mientras opera la m\u00e1quina", "Caminar hacia la m\u00e1quina y detenerla t\u00fa mismo"])
    ]
  },
  {
    id: "shear-line-helper",
    category: "Machine helper",
    title: "Shear Line Helper Safety Knowledge",
    equipment: "Shear Line",
    role: "Machine Helper",
    description: "Covers helper positioning, machine-control boundaries, PPE, material handling, communication with the operator, and when to stop work.",
    rubric: competencyStages.map((stage) => ({ ...stage, title: stage.title.replace("Machine-Specific", "Helper Task") })),
    questions: [
      mc("q1", "As a helper at the shear line, where must you NEVER stand or reach during a cut cycle?", ["Behind the back gauge", "In front of or over the blade line, or anywhere inside the cutting zone \u2014 the blade descends at high speed and force", "To the side of the sheet being cut", "Near the hold-down clamp controls"], "B", "Como ayudante en la guillotina, \u00bfd\u00f3nde NUNCA debes pararte ni meter la mano durante un ciclo de corte?", ["Detr\u00e1s del tope trasero", "Frente a la l\u00ednea de la cuchilla o dentro de la zona de corte: la cuchilla desciende a alta velocidad y con gran fuerza", "A un lado de la l\u00e1mina que se est\u00e1 cortando", "Cerca de los controles de la prensa de sujeci\u00f3n"]),
      mc("q2", "When assisting with a large sheet on the shear, where should the helper be positioned?", ["Directly in front of the blade to guide the sheet edge into position", "On the side or outfeed end of the sheet, supporting its weight without reaching over or in front of the blade line", "Behind the back gauge to push the material forward", "Anywhere that is most convenient"], "B", "Al asistir con una l\u00e1mina grande en la guillotina, \u00bfd\u00f3nde debe posicionarse el ayudante?", ["Directamente frente a la cuchilla para guiar el borde de la l\u00e1mina hacia su posici\u00f3n", "A un lado o en el extremo de salida de la l\u00e1mina, soportando su peso sin alcanzar sobre ni frente a la l\u00ednea de la cuchilla", "Detr\u00e1s del tope trasero para empujar el material hacia adelante", "En el lugar que resulte m\u00e1s conveniente"]),
      mc("q3", "Who activates the shear foot pedal or hand control during a cut?", ["The helper, to keep the operator's hands free for material control", "Either person \u2014 whoever is ready", "The primary operator only \u2014 the helper never activates the cut control", "The supervisor"], "C", "\u00bfQui\u00e9n activa el pedal o el control de mano de la guillotina durante un corte?", ["El ayudante, para que el operador tenga las manos libres para controlar el material", "Cualquiera de los dos: quien est\u00e9 listo", "Solo el operador principal: el ayudante nunca activa el control de corte", "El supervisor"]),
      mc("q4", "What PPE is required for a helper working at the shear line?", ["No PPE \u2014 helpers only stack parts", "Safety glasses, steel-toe boots, and leather work gloves when handling sheet metal; no loose clothing, rings, or jewelry", "Only a hard hat", "Only hearing protection and a hard hat"], "B", "\u00bfQu\u00e9 EPP se requiere para un ayudante que trabaja en la guillotina?", ["No se requiere EPP: los ayudantes solo apilan piezas", "Lentes de seguridad, botas con puntera de acero y guantes de trabajo de cuero al manejar l\u00e1mina met\u00e1lica; sin ropa suelta, anillos ni joyer\u00eda", "Solo casco", "Solo protecci\u00f3n auditiva y casco"]),
      mc("q5", "After a cut is made, how should a helper handle the freshly cut sheet metal piece?", ["Grab it quickly bare-handed before it falls", "Use leather gloves at all times \u2014 freshly sheared edges are razor-sharp; carry pieces carefully and stack them flat and stably in the designated area", "Slide the piece off the table with your forearm", "Stack pieces vertically leaning against the shear frame"], "B", "Despu\u00e9s de un corte, \u00bfc\u00f3mo debe manejar el ayudante la pieza de l\u00e1mina reci\u00e9n cortada?", ["Agarrarla r\u00e1pidamente con las manos desnudas antes de que caiga", "Usar guantes de cuero siempre: los bordes reci\u00e9n cortados por guillotina son como navaja; cargar las piezas con cuidado y apilarlas planas y establemente en el \u00e1rea designada", "Deslizar la pieza de la mesa con el antebrazo", "Apilar las piezas verticalmente apoyadas contra el bastidor de la guillotina"]),
      mc("q6", "If the helper needs to reposition or adjust the sheet before a cut, when is it safe to do so?", ["Anytime \u2014 just move quickly", "Only after the blade has fully returned to home position AND the operator confirms it is safe to adjust the material", "While the hold-downs are clamping the sheet", "While the operator is programming the back gauge"], "B", "Si el ayudante necesita reposicionar o ajustar la l\u00e1mina antes de un corte, \u00bfcu\u00e1ndo es seguro hacerlo?", ["En cualquier momento: solo mu\u00e9vete r\u00e1pido", "Solo despu\u00e9s de que la cuchilla haya regresado completamente a la posici\u00f3n de inicio Y el operador confirme que es seguro ajustar el material", "Mientras las prensas de sujeci\u00f3n est\u00e1n sujetando la l\u00e1mina", "Mientras el operador est\u00e1 programando el tope trasero"]),
      mc("q7", "What should a helper do if they notice the front safety guard on the shear is missing or not in place?", ["Continue working \u2014 the guard is the operator's responsibility", "Alert the operator and supervisor immediately \u2014 the machine must not be run without a functional guard in place", "Tape a warning near the blade area and continue", "Try to reinstall the guard yourself"], "B", "\u00bfQu\u00e9 debe hacer el ayudante si nota que el protector frontal de la guillotina est\u00e1 faltante o no est\u00e1 en su lugar?", ["Continuar trabajando: el protector es responsabilidad del operador", "Alertar al operador y al supervisor de inmediato: la m\u00e1quina no debe operarse sin un protector funcional en su lugar", "Poner una advertencia cerca de la zona de la cuchilla y continuar", "Intentar reinstalar el protector t\u00fa mismo"]),
      mc("q8", "When scrap drops off the shear table after a cut, what is the correct way to remove it?", ["Reach under the blade area quickly before the next cycle", "Wait until the blade is fully at home and the operator confirms it is safe, then use gloves to remove scrap from the safe side", "Kick the scrap away with your foot while the machine is running", "Let scrap accumulate on the floor until the end of the shift"], "B", "Cuando la chatarra cae de la mesa de la guillotina despu\u00e9s de un corte, \u00bfcu\u00e1l es la forma correcta de retirarla?", ["Meter la mano bajo la zona de la cuchilla r\u00e1pidamente antes del siguiente ciclo", "Esperar a que la cuchilla est\u00e9 completamente en posici\u00f3n de inicio y el operador confirme que es seguro, luego usar guantes para retirar la chatarra por el lado seguro", "Patear la chatarra con el pie mientras la m\u00e1quina est\u00e1 en marcha", "Dejar que la chatarra se acumule en el suelo hasta el final del turno"]),
      mc("q9", "As a helper, are you allowed to change the back gauge setting or adjust the blade gap on the shear?", ["Yes, if the operator asks you", "Yes, to help speed up the job", "No \u2014 all machine settings and adjustments are the operator's responsibility only", "Only if the supervisor is not watching"], "C", "Como ayudante, \u00bftienes permitido cambiar la configuraci\u00f3n del tope trasero o ajustar la holgura de la cuchilla en la guillotina?", ["S\u00ed, si el operador te lo pide", "S\u00ed, para ayudar a acelerar el trabajo", "No: todas las configuraciones y ajustes de la m\u00e1quina son responsabilidad exclusiva del operador", "Solo si el supervisor no est\u00e1 observando"]),
      mc("q10", "What should a helper do if they feel unsafe or unsure about their position near the shear during any operation?", ["Push through \u2014 production must not stop", "Stop, step away from the machine, and communicate with the operator before continuing \u2014 no task is worth risking injury", "Stay in place and try to figure it out quietly", "Activate the machine controls to stop the cycle yourself"], "B", "\u00bfQu\u00e9 debe hacer el ayudante si se siente inseguro o no est\u00e1 seguro de su posici\u00f3n cerca de la guillotina durante cualquier operaci\u00f3n?", ["Seguir adelante: la producci\u00f3n no debe detenerse", "Detenerse, alejarse de la m\u00e1quina y comunicarse con el operador antes de continuar: ninguna tarea vale arriesgar una lesi\u00f3n", "Quedarse en su lugar e intentar resolverlo en silencio", "Activar los controles de la m\u00e1quina para detener el ciclo \u00e9l mismo"])
    ]
  },
  ...
  },
  {
    ...
    questions: [
      ...
      mc("q3", "How should a load be carried while traveling?", ["Tilted back slightly, forks low to the ground", "Raised as high as possible for visibility", "Tilted forward to see under the load", "It does not matter as long as it is stable"], "A", "Como se debe transportar una carga al manejar?", ["Inclinada ligeramente hacia atras, unas bajas cerca del suelo", "Lo mas alta posible para visibilidad", "Inclinada hacia adelante para ver debajo de la carga", "No importa mientras este estable"]),
      mc("q4", "What must the operator do at blind intersections?", ["Speed up to clear the area quickly", "Sound the horn and slow down/stop as needed", "Nothing, pedestrians will yield", "Flash the lights only"], "B", "Que debe hacer el operador en intersecciones sin visibilidad?", ["Acelerar para pasar rapido", "Tocar la bocina y bajar velocidad/detenerse si es necesario", "Nada, los peatones se moveran", "Solo prender y apagar las luces"]),
      mc("q5", "What is required before driving up or down a ramp with a load?", ["Load faces downhill going up and down", "Travel sideways on the ramp", "Load faces uphill; travel straight, never diagonally or turn on the ramp", "No special procedure is needed"], "C", "Que se requiere antes de subir o bajar una rampa con carga?", ["La carga mira cuesta abajo al subir y bajar", "Manejar de lado en la rampa", "La carga mira cuesta arriba; avanzar derecho, nunca diagonal ni girar en la rampa", "No se necesita procedimiento especial"]),
      mc("q6", "When must the seatbelt be worn?", ["Anytime the forklift is being operated", "Only outdoors", "Only when carrying a load", "Seatbelt use is optional"], "A", "Cuando se debe usar el cinturon de seguridad?", ["Siempre que se opere el montacargas", "Solo afuera", "Solo cuando lleva carga", "El cinturon es opcional"]),
      mc("q7", "What is the maximum rated load capacity based on?", ["Operator's experience level", "The forklift's data plate, at the load's center of gravity", "Company policy only", "Whatever fits on the forks"], "B", "En que se basa la capacidad maxima de carga?", ["Experiencia del operador", "La placa de datos del montacargas, segun el centro de gravedad de la carga", "Solo politica de la compania", "Lo que quepa en las unas"]),
      yn("q8", "Can the operator identify the data plate, stability limits, and pedestrian hazards without help?", "Yes", "Puede el operador identificar la placa de datos, limites de estabilidad y peligros para peatones sin ayuda?"),
      textq("q9", "Trainer notes: describe the supervised work observed and any limits or corrective actions.", "Notas del instructor: describa el trabajo supervisado observado y cualquier limite o accion correctiva.")
    ]
  },
  {
    id: "crane-operator",
  ...
  {
    id: "telehandler-operator",
    category: "Equipment operator",
    title: "Skytrak / Telehandler Operator Competency",
    equipment: "Skytrak / Telehandler",
    role: "Machine Operator",
    ...
    questions: [
      ...
      mc("q3", "What is the main tip-over risk with telehandlers?", ["Extending the boom too far with too heavy a load, especially on uneven ground", "Driving too slowly", "Using low beam headlights", "Parking on flat ground"], "A", "Cual es el principal riesgo de volcadura con telehandlers?", ["Extender demasiado la pluma con una carga muy pesada, especialmente en terreno irregular", "Manejar muy despacio", "Usar luces bajas", "Estacionarse en terreno plano"]),
      mc("q4", "What should the operator do before lifting near overhead power lines?", ["Ignore them if the load is light", "Only worry about lines below 10 feet", "Maintain required clearance distance and get a spotter if needed", "Touch the line briefly to test it"], "C", "Que debe hacer el operador antes de levantar cerca de lineas electricas aereas?", ["Ignorarlas si la carga es ligera", "Preocuparse solo por lineas debajo de 10 pies", "Mantener la distancia requerida y usar observador si es necesario", "Tocar la linea brevemente para probarla"]),
      mc("q5", "How should the load be carried while traveling?", ["Boom fully raised for visibility", "Boom low and retracted, load tilted back", "Boom fully extended for reach", "It does not matter"], "B", "Como se debe transportar la carga al manejar?", ["Pluma completamente levantada para visibilidad", "Pluma baja y retraida, carga inclinada hacia atras", "Pluma completamente extendida para alcance", "No importa"]),
      mc("q6", "What must be done before dismounting the machine?", ["Lower the load/forks, set park brake, neutral gears, shut down", "Leave the load raised for the next operator", "Just turn the key off", "Sound the horn once"], "A", "Que se debe hacer antes de bajarse de la maquina?", ["Bajar la carga/unas, poner freno de estacionamiento, neutral y apagar", "Dejar la carga levantada para el siguiente operador", "Solo apagar la llave", "Tocar la bocina una vez"]),
      mc("q7", "What PPE is required when operating a telehandler?", ["No PPE required in the cab", "Only gloves", "Only a hard hat", "Hard hat, safety glasses, high-visibility vest, seatbelt worn at all times"], "D", "Que EPP se requiere al operar un telehandler?", ["No se requiere EPP en la cabina", "Solo guantes", "Solo casco", "Casco, lentes de seguridad, chaleco de alta visibilidad y cinturon siempre puesto"]),
      yn("q8", "Can the operator identify the load chart, stability limits, and overhead hazards without help?", "Yes", "Puede el operador identificar la tabla de carga, limites de estabilidad y peligros aereos sin ayuda?"),
      textq("q9", "Trainer notes: describe the supervised work observed and any limits or corrective actions.", "Notas del instructor: describa el trabajo supervisado observado y cualquier limite o accion correctiva.")
    ]
  },
  {
